...
if (process.env.NODE_ENV !== "production") {
  (function() {
    ...
    function findCurrentUnmaskedContext(fiber) {
      ...
      !(isFiberMounted(fiber) && (fiber.tag === ClassComponent || fiber.tag === ClassComponentLazy))
        ? invariant(
            false,
    ...
    function findEarliestOutstandingPriorityLevel(root, renderExpirationTime) {
      ...
      if (
        ...
        (earliestPendingTime !== NoWork && earliestPendingTime < earliestExpirationTime)
      ) {
        earliestExpirationTime = earliestPendingTime;
      }
      if (
        earliestExpirationTime === NoWork ||
        (earliestSuspendedTime !== NoWork && earliestSuspendedTime < earliestExpirationTime)
      ) {
            ...
            if (dependency.context === context && (dependency.observedBits & changedBits) !== 0) {
              ...
              while (node !== null) {
                ...
                if (node.childExpirationTime === NoWork || node.childExpirationTime > renderExpirationTime) {
                  ...
                  if (
                    alternate !== null &&
                    (alternate.childExpirationTime === NoWork || alternate.childExpirationTime > renderExpirationTime)
                  ) {
    ...
    function resumeMountClassInstance(workInProgress, ctor, newProps, renderExpirationTime) {
      ...
      var shouldUpdate =
        checkHasForceUpdateAfterProcessing() ||
        checkShouldComponentUpdate(workInProgress, ctor, oldProps, newProps, oldState, newState, nextLegacyContext);
        ...
        workInProgress.tag = FunctionalComponent;
        {
          ...
          if (workInProgress.ref !== null) {
            ...
            if (!didWarnAboutStatelessRefs[warningKey]) {
              ...
              warning$1(
                false,
                "Stateless function components cannot be given refs. " + "Attempts to access this ref will fail.%s",
                info,
              );
            }
          }
  ...
  */
    ...
    function resetChildExpirationTime(workInProgress, renderTime) {
      ...
      if (enableProfilerTimer && workInProgress.mode & ProfileMode) {
        ...
        while (_child !== null) {
          ...
          if (
            newChildExpirationTime === NoWork ||
            (_childUpdateExpirationTime !== NoWork && _childUpdateExpirationTime < newChildExpirationTime)
          ) {
            newChildExpirationTime = _childUpdateExpirationTime;
          }
          if (
            newChildExpirationTime === NoWork ||
            (_childChildExpirationTime !== NoWork && _childChildExpirationTime < newChildExpirationTime)
          ) {
    ...
    ReactDOM.unstable_createRoot = function createRoot(container, options) {
      !isValidContainer(container)
        ? invariant(false, "unstable_createRoot(...): Target container is not a DOM element.")
        : void 0;
