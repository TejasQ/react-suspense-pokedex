  ...
  (function() {
          ...
          if (queue.length) {
            ...
            if (oldReplace && oldQueue.length === 1) {
              ...
              for (var i = oldReplace ? 1 : 0; i < oldQueue.length; i++) {
                ...
                var _partialState =
                  typeof partial === "function" ? partial.call(inst, nextState, element.props, publicContext) : partial;
    ...
    var ReactDOMServerRenderer = (function() {
      ...
      ReactDOMServerRenderer.prototype.popProvider = function popProvider(provider) {
        {
          !(this.providerIndex > -1 && provider === this.providerStack[this.providerIndex])
        ...
        if (typeof child === "string" || typeof child === "number") {
          ...
          var info = "";
          {
            ...
            if (
              ...
              (typeof elementType === "object" && elementType !== null && Object.keys(elementType).length === 0)
            ) {
              info +=
