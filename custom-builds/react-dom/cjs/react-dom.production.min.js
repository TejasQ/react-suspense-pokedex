...
function processChildContext(fiber, type, parentContext) {
  ...
  for (var contextKey in childContext) {
    !(contextKey in childContextTypes)
      ? reactProdInvariant("108", getComponentName(type) || "Unknown", contextKey)
      : void 0;
  }
...
function isPriorityLevelSuspended(root, expirationTime) {
  ...
  var latestSuspendedTime = root.latestSuspendedTime;
  return (
    earliestSuspendedTime !== NoWork && expirationTime >= earliestSuspendedTime && expirationTime <= latestSuspendedTime
  );
}
...
function mountIndeterminateComponent(current$$1, workInProgress, Component, renderExpirationTime) {
  !(current$$1 === null) ? reactProdInvariant("155") : void 0;
...
function commitRoot(root, finishedWork) {
  ...
  var earliestRemainingTimeBeforeCommit =
    ...
    (childExpirationTimeBeforeCommit !== NoWork && childExpirationTimeBeforeCommit < updateExpirationTimeBeforeCommit)
